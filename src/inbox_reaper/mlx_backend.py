...
def generate_text(
    ...
    Args:
        ...
        json_schema: Optional JSON schema to enforce structured output.
                     If provided, the prompt will be augmented to request JSON.
...
async def generate_text_async(
    ...
    # Use functools.partial to pass all arguments including json_schema
    import functools

    generate_fn = functools.partial(
        generate_text, model_name, prompt, max_tokens, json_schema
    )
